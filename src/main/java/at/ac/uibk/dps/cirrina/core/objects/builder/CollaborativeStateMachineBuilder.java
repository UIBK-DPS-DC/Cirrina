...
/**
 * Collaborative state machine builder, builds a collaborative state machine based on a collaborative state machine
 * class.
 */
public class CollaborativeStateMachineBuilder {
   ...
   *
   * @param collaborativeStateMachineClass The collaborative state machine class used to build the collaborative state
   *                                       machine.
   */
  ...
  /**
   * Populates the source state machines according to pre-populated source state machines and raised events. The table
   * is expected to represent the source state machine (row), raised event (column), and target state machines (cell).
   *
  ...
  /**
   * Populates the target state machines according to pre-populated source state machines and raised events. The table
   * is expected to represent the source state machine (row), raised event (column), and target state machines (cell).
   *
   * @param events Raised events table.
   */
  ...
  /**
   * Add edges to the currently building collaborative state machine according to the provided table. The table is
   * expected to represent the source state machine (row), raised event (column), and target state machines (cell).
   *
   * @param events Raised events table.
   */

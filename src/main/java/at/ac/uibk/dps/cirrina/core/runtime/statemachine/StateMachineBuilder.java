...
import at.ac.uibk.dps.cirrina.core.runtime.state.StateBuilder;
import at.ac.uibk.dps.cirrina.core.runtime.transition.TransitionBuilder;
...
public final class StateMachineBuilder {
  ...
  private StateMachine buildChild(String inheritName)
    ...
    StateMachine baseStateMachine = knownStateMachines.stream()
